...
public class Driver {
    ...
    public static void createandStoreInstances(EventController event){
        ...
        Consumable consumable1 = new Consumable("Healing Potion", "Healing", 1, true, false, playerEffects1, playerValues1, 0);

        String[] playerEffects2 = {"Attack", "Defense"}; 
        int[] playerValues2 = {20, -10}; 
        Consumable consumable2 = new Consumable("Rage Elixer", "Buff", 1, true, false, playerEffects2, playerValues2, 3);
