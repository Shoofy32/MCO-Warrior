...
public abstract class Consumable {
     ...
     */
    public Consumable(String name, String type, ImageIcon image, int maxCharges, boolean affectsHolder, boolean affectsTarget, String[] statsToEffect,
    ...
    private void restoreStats(Entity holder, Entity target){
        ...
        if(affectsHolder)
            size = statValuesToAffectHolder.length;
