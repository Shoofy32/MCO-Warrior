...
public class Environment {
    ...
    private String playerEffectDescription; //Stores the description of the Player effects
    ...
    private String enemyEffectDescription; //Stores the description of the Enemy effects
     ...
     */
    public Environment(String name, boolean hasEffect, ImageIcon image, int playerStatEffect, String playerStatToEffect, 
